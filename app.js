var express = require('express'),
  ...
  //   .use( 'entity' )
  //   .use( require('./api/index') )
  //   .client( { type:'tcp',  pin:'role:kpi' } );
  ...
  app.get('/', function (req, res) {
    res.render('index', { title:'Cuadro de Mando Integral' })
  });
...
app.all('*', function(req, res){
  ...
  res.render('index', { title: 'test', sectionDescription: 'test'});
});